...
const faqs: FAQ[] = [
  ...
  { q: 'Can I contribute my own builds?', a: 'Yes! Create a GitHub repo with SKILL.md files following the Agent Skills format. Run `npx clawclawgo publish` to auto-submit a PR to the registry, or manually add your repo URL to registry/builds.json.' },
