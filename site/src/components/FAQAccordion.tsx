...
const faqs: FAQ[] = [
  ...
  { q: 'How do I use a kit?', a: 'Find a kit you like. Click to view details. Download the JSON, copy the CLI command, or view it on GitHub. Give it to your AI agent — it will handle the rest. No manual setup required.' },
  ...
  { q: 'Can I contribute my own kits?', a: 'Yes! Create a GitHub repo with SKILL.md files following the Agent Skills format. Run `npx clawclawgo push` to auto-submit a PR to the registry, or manually add your repo URL to registry/kits.json.' },
